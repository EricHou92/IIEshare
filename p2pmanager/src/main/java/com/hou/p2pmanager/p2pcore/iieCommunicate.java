 ...
 * 接收端和发送端的udp交互
 */
public class iieCommunicate extends Thread{

    private static final String tag = iieCommunicate.class.getSimpleName();
    ...
    public iieCommunicate(P2PManager manager, iieHandler handler, Context context)
    {
        mContext = context;
